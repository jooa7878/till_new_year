...
### v1.2 - 난이도 밸런싱 (2024.12.26)
- 1~2단계 난이도 상향 조정
- 3단계부터 Wave 패턴 등장
- 5단계 난이도 하향 조정
- 스테이지 타이틀 변경 (`STAGE N` → `12월 NN일이 지나고 있습니다`)

### v1.1 - 점수 시스템 개선 (2024.12.26)
- 실시간 점수 표시 기능 추가
- 오래 버틸수록 높은 점수 획득 (최대 x3배)
- 후반 스테이지 보너스 점수 추가
- 점수 계산 버그 수정

### v1.0 - 정식 출시 (2024.12.26)
- 6개 스테이지 (12월 26일 ~ 31일)
- 5가지 총알 패턴 (Random, Aimed, Wave, Burst, Spiral)
- 모바일 터치 컨트롤 지원
- 반응형 레이아웃
- 하이스코어 저장 기능
